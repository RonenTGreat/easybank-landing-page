    ...
    <footer className=" grid place-items-center py-10 w-full absolute left-0 right-0 mx-auto top-[240rem] bg-dark-blue">
      ...
      <div className=" mt-5 flex justify-center gap-3">
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20">
          <path
            className=" hover:fill-lime-green"
            fill="#FFF"
      ...
      <ul className=" text-sm text-center text-light-grayish-blue font-light mt-5">
        <li className=" mt-2 hover:text-lime-green">About Us</li>
        <li className=" mt-2 hover:text-lime-green">Contact</li>
        <li className=" mt-2 hover:text-lime-green">Blog</li>
        <li className=" mt-2 hover:text-lime-green">Careers</li>
        <li className=" mt-2 hover:text-lime-green">Support</li>
        <li className=" mt-2 hover:text-lime-green">Privacy Policy</li>
      </ul>
      <a
        href="/#"
        className=" mt-7 bg-gradient-to-r from-lime-green to-bright-cyan text-white py-2 px-6 rounded-full text-base font-bold"
      >
        Request Invite
      </a>
      <p className=" text-grayish-blue text-sm mt-5">© Easybank. All Rights Reserved</p>
    </footer>
  );
};
